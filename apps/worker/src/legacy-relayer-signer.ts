/** Compatibility path for chains not opted into exclusive durable sending.
 * Retains the deployed broadcast-only lock and existing sender. */
/**
 ...
 */
export class LegacyRelayerSigner {

...
const manifest: AgentManifest = { chainId: 137, relayer: a(9), gate: a(1), manager: a(2), jpyc: a(3), usdc: a(4), accountImplementation: a(5), adapter: a(6),
...
describe('configured Polygon execution boundary', () => {
  it('accepts 137 only with both token implementation pins', () => {
